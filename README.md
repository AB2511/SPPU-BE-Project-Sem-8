...
2. Navigate to any subject folder:
...
4. Run the assignment files

---

## 📌 Notes

* All implementations follow SPPU syllabus guidelines
* Code is written for academic learning and demonstration
* Outputs may vary slightly depending on system
